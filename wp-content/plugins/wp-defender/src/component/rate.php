...
class Rate extends \Calotes\Base\Component {
	...
	public function __construct() {
		$this->button_rate = __( 'Rate Defender', 'wpdef' );
		$this->button_later = __( 'Maybe later', 'wpdef' );
		...
		if ( self::get_count_scans( self::SLUG_COMPLETED_SCANS ) >= self::NUMBER_COMPLETED_SCANS ) {
			return [
				...
				'text' => sprintf(
					...
					__( 'You\'ve completed %d malware scans - that\'s a lot of scans! We are happy to be a part of helping you secure your site and we would appreciate it if you dropped us a rating on wp.org to help us spread the word and boost our motivation.', 'wpdef' ),
			...
			return [
				...
				'text' => sprintf(
					/* translators: %d - Number of completed scans. */
					__( 'You\'ve successfully resolved %d malware scan issues! We are happy to be a part of helping you secure your site, and we would appreciate it if you dropped us a rating on wp.org to help us spread the word and boost our motivation.', 'wpdef' ),
