...
class Forminator_Quizzes extends Forminator_Module {
	...
	public function options() {
		return array(
			...
			'singular_name' => esc_html__( 'Quiz', 'forminator' ),
			'description'   => esc_html__( 'Create fun quizzes for your users to take and share on social media. A great way to drive more traffic to your site.', 'forminator' ),
			'button_label'  => esc_html__( 'New Quiz', 'forminator' ),
