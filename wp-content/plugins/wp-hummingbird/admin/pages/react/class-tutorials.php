		...
		<div class="sui-header">
			...
			<div class="sui-actions-right">
				<?php if ( ! apply_filters( 'wpmudev_branding_hide_doc_link', false ) ) : ?>
					<a href="<?php echo esc_url( Utils::get_link( 'tutorials', 'hummingbird_tutorials_page' ) ); ?>" target="_blank" class="sui-button sui-button-ghost">
