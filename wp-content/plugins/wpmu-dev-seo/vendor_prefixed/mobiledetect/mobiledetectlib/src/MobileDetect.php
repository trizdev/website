 ...
 * @method bool isWatch()
 */
namespace Smartcrawl_Vendor\Detection;
...
class MobileDetect
{
    ...
    protected static array $operatingSystems = [
        ...
        'webOS' => 'webOS|hpwOS',
        'badaOS' => 'Smartcrawl_Vendor\\bBada\\b',
        'BREWOS' => 'BREW',
    ];
    /**
    ...
    protected static array $browsers = [
        ...
        'Dolfin' => 'Smartcrawl_Vendor\\bDolfin\\b',
        ...
        //'Midori'          => 'midori',
        //'Tizen'           => 'Tizen',
        'WeChat' => 'Smartcrawl_Vendor\\bMicroMessenger\\b',
        ...
        'Mercury' => 'Smartcrawl_Vendor\\bMercury\\b',
