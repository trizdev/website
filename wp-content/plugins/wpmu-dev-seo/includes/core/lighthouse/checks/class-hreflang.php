...
class Hreflang extends Check {
			...
			<ul>
				<li style="margin-bottom: 25px;">
					...
					printf(
						...
						esc_html__( 'The best approach to building a multilingual WordPress site is by using a multilingual plugin. A multilingual WordPress plugin allows you to easily create and manage content in multiple languages using the same WordPress core software. Some examples: %1$s or %2$s.', 'wds' ),
						sprintf(
	...
	public function get_action_button() {
		...
		return $this->button_markup(
			esc_html__( 'HREFLANG Plugins', 'wds' ),
			$url,
