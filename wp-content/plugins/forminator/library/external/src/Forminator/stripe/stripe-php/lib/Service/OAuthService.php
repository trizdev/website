...
class OAuthService extends \Forminator\Stripe\Service\AbstractService
{
    /**
    ...
    public function authorizeUrl($params = null, $opts = null)
    {
        ...
        $query = \Forminator\Stripe\Util\Util::encodeParameters($params);
    ...
    private function _parseOpts($opts)
    {
        ...
        return \Forminator\Stripe\Util\RequestOptions::parse($opts);
    }
    /**
