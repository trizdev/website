...
class Recaptcha extends \Calotes\Model\Setting {
	...
	public function labels(): array {
		return [
			...
			'v2_checkbox' => __( 'V2 Checkbox', 'wpdef' ),
			'v2_invisible' => __( 'V2 Invisible', 'wpdef' ),
			'v3_recaptcha' => __('reCAPTCHA V3', 'wpdef' ),
			...
			'disable_for_known_users' => __( 'Disable for logged in users', 'wpdef' ),
		];
	}
	...
	public static function get_module_name(): string {
		return __( 'Google reCAPTCHA', 'wpdef' );
	}
}