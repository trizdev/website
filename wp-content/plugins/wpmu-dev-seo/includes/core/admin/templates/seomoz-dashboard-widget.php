...
<table class="sui-table">
	...
	<tr>
		<td>
			...
			printf(
				...
				esc_html__( 'Measure of the mozRank %s of the domain in the Linkscape index', 'wds' ),
	...
	<tr>
		<td>
			...
			printf(
				/* translators: %s: Link to help */
				esc_html__( 'The number of external (from other subdomains), juice passing links %s to the target URL in the Linkscape index', 'wds' ),
	...
	<tr>
		<td>
			...
			printf(
				/* translators: %s: Link to help */
				esc_html__( 'The number of internal and external, juice and non-juice passing links %s to the target URL in the Linkscape index', 'wds' ),
	...
	<tr>
		<td>
			...
			printf(
				/* translators: %s: Link to help */
				esc_html__( 'Measure of the mozRank %s of the homepage URL in the Linkscape index', 'wds' ),
				'<a href="https://moz.com/learn/seo/mozrank" target="_blank">(?)</a>'
			);
			?>
		</td>
