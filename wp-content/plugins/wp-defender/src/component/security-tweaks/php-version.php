...
class PHP_Version extends Component {
	...
	private function set_php_versions() {
		...
		$supported_php = apply_filters( "defender_{$this->slug}_supported_php", [ '7.2', '7.3', '7.4', '8.0', '8.1', '8.2' ] );
	...
	public function to_array(): array {
		...
		return [
			...
			/* translators: %s: Min PHP version. %s: Min PHP version. */
				__( "PHP versions older than %s are no longer supported. For security and stability we strongly recommend you upgrade your PHP version to version %s or newer as soon as possible.", 'wpdef' ),
				$this->min_php,
				$this->min_php
			),
