...
<p style="font-family: inherit; font-size: 16px; margin: 0 0 30px">
	...
	$resubscribe .= __( 'resubscribe', 'wpdef' );
	$resubscribe .= '</a>';
	/* translators: 1. Notification name. 2. Resubscribe-action. */
	printf(
		__( 'You are now unsubscribed from %1$s. If you made a mistake and wish to continue receiving these emails, you can %2$s.', 'wpdef' ),
