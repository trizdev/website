...
abstract class Entity {
	...
	public function apply_macros( $subject, $module = 'general' ) {
		...
		$macro_keys = apply_filters_deprecated(
			...
			__( 'Please use our new filter `smartcrawl_known_macros_keys` in SmartCrawl.' )
		);
		...
		$macro_values = apply_filters_deprecated(
			...
			__( 'Please use our new filter `smartcrawl_known_macros_values` in SmartCrawl.' )
		);
		...
		$macros = apply_filters_deprecated(
			...
			__( 'Please use our new filter `smartcrawl_known_macros` in SmartCrawl.' )
		);
