 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Drive extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->about = new Forminator_Google_Service_Drive_About_Resource(
        $this,
        $this->serviceName,
        'about',
        array(
    ...
    $this->changes = new Forminator_Google_Service_Drive_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->channels = new Forminator_Google_Service_Drive_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->comments = new Forminator_Google_Service_Drive_Comments_Resource(
        $this,
        $this->serviceName,
        'comments',
        array(
    ...
    $this->files = new Forminator_Google_Service_Drive_Files_Resource(
        $this,
        $this->serviceName,
        'files',
        array(
    ...
    $this->permissions = new Forminator_Google_Service_Drive_Permissions_Resource(
        $this,
        $this->serviceName,
        'permissions',
        array(
    ...
    $this->replies = new Forminator_Google_Service_Drive_Replies_Resource(
        $this,
        $this->serviceName,
        'replies',
        array(
    ...
    $this->revisions = new Forminator_Google_Service_Drive_Revisions_Resource(
        $this,
        $this->serviceName,
        'revisions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $driveService = new Forminator_Google_Service_Drive(...);
 *   $about = $driveService->about;
 *  </code>
 */
class Forminator_Google_Service_Drive_About_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Drive_About
   */
  public function get($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_About");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Changes_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_StartPageToken
   */
  public function getStartPageToken($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getStartPageToken', array($params), "Forminator_Google_Service_Drive_StartPageToken");
  }
   ...
   * @return Forminator_Google_Service_Drive_ChangeList
   */
  public function listChanges($pageToken, $optParams = array())
  {
    $params = array('pageToken' => $pageToken);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_ChangeList");
  }
   ...
   * the next page. This should be set to the value of 'nextPageToken' from the
   * previous response or to the response from the getStartPageToken method.
   * @param Forminator_Google_Channel $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool includeRemoved Whether to include changes indicating that
   * items have left the view of the changes list, for example by deletion or lost
   ...
   * @opt_param string spaces A comma-separated list of spaces to query within the
   * user corpus. Supported values are 'drive', 'appDataFolder' and 'photos'.
   * @return Forminator_Google_Service_Drive_Channel
   */
  public function watch($pageToken, Forminator_Google_Service_Drive_Channel $postBody, $optParams = array())
  {
    $params = array('pageToken' => $pageToken, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Forminator_Google_Service_Drive_Channel");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Channels_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Forminator_Google_Service_Drive_Channel $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Comments_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param Forminator_Google_Comment $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_Comment
   */
  public function create($fileId, Forminator_Google_Service_Drive_Comment $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Drive_Comment");
  }
  ...
  public function get($fileId, $commentId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_Comment");
  }
   ...
   * @return Forminator_Google_Service_Drive_CommentList
   */
  public function listComments($fileId, $optParams = array())
  {
    $params = array('fileId' => $fileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_CommentList");
  }
   ...
   * @return Forminator_Google_Service_Drive_Comment
   */
  public function update($fileId, $commentId, Forminator_Google_Service_Drive_Comment $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Drive_Comment");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Files_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param string $fileId The ID of the file.
   * @param Forminator_Google_DriveFile $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Drive_DriveFile
   */
  public function copy($fileId, Forminator_Google_Service_Drive_DriveFile $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('copy', array($params), "Forminator_Google_Service_Drive_DriveFile");
  }
   ...
   * @return Forminator_Google_Service_Drive_DriveFile
   */
  public function create(Forminator_Google_Service_Drive_DriveFile $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Drive_DriveFile");
  }
   ...
   * @return Forminator_Google_Service_Drive_GeneratedIds
   */
  public function generateIds($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('generateIds', array($params), "Forminator_Google_Service_Drive_GeneratedIds");
  }
  ...
  public function get($fileId, $optParams = array())
  {
    $params = array('fileId' => $fileId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_DriveFile");
  }
   ...
   * @return Forminator_Google_Service_Drive_FileList
   */
  public function listFiles($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_FileList");
  }
   ...
   * @return Forminator_Google_Service_Drive_DriveFile
   */
  public function update($fileId, Forminator_Google_Service_Drive_DriveFile $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Drive_DriveFile");
  }
   ...
   * @return Forminator_Google_Service_Drive_Channel
   */
  public function watch($fileId, Forminator_Google_Service_Drive_Channel $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Forminator_Google_Service_Drive_Channel");
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Permissions_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param string $fileId The ID of the file.
   * @param Forminator_Google_Permission $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Drive_Permission
   */
  public function create($fileId, Forminator_Google_Service_Drive_Permission $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Drive_Permission");
  }
  ...
  public function get($fileId, $permissionId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'permissionId' => $permissionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_Permission");
  }
   ...
   * @param string $fileId The ID of the file.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_PermissionList
   */
  public function listPermissions($fileId, $optParams = array())
  {
    $params = array('fileId' => $fileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_PermissionList");
  }
   ...
   * @return Forminator_Google_Service_Drive_Permission
   */
  public function update($fileId, $permissionId, Forminator_Google_Service_Drive_Permission $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Drive_Permission");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Replies_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $fileId The ID of the file.
   * @param string $commentId The ID of the comment.
   * @param Forminator_Google_Reply $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_Reply
   */
  public function create($fileId, $commentId, Forminator_Google_Service_Drive_Reply $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Drive_Reply");
  }
  ...
  public function get($fileId, $commentId, $replyId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_Reply");
  }
   ...
   * on the next page. This should be set to the value of 'nextPageToken' from the
   * previous response.
   * @return Forminator_Google_Service_Drive_ReplyList
   */
  public function listReplies($fileId, $commentId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_ReplyList");
  }
   ...
   * @return Forminator_Google_Service_Drive_Reply
   */
  public function update($fileId, $commentId, $replyId, Forminator_Google_Service_Drive_Reply $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Drive_Reply");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Drive_Revisions_Resource extends Forminator_Google_Service_Resource
{
   ...
   * of downloading known malware or other abusive files. This is only applicable
   * when alt=media.
   * @return Forminator_Google_Service_Drive_Revision
   */
  public function get($fileId, $revisionId, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'revisionId' => $revisionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Drive_Revision");
  }
   ...
   * @param string $fileId The ID of the file.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_RevisionList
   */
  public function listRevisions($fileId, $optParams = array())
  {
    $params = array('fileId' => $fileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Drive_RevisionList");
  }
   ...
   * @param string $fileId The ID of the file.
   * @param string $revisionId The ID of the revision.
   * @param Forminator_Google_Revision $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Drive_Revision
   */
  public function update($fileId, $revisionId, Forminator_Google_Service_Drive_Revision $postBody, $optParams = array())
  {
    $params = array('fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Drive_Revision");
  }
}
...
class Forminator_Google_Service_Drive_About extends Forminator_Google_Collection
{
  ...
  protected $storageQuotaType = 'Forminator_Google_Service_Drive_AboutStorageQuota';
  protected $storageQuotaDataType = '';
  protected $userType = 'Forminator_Google_Service_Drive_User';
  ...
  public function setStorageQuota(Forminator_Google_Service_Drive_AboutStorageQuota $storageQuota)
  {
  ...
  public function setUser(Forminator_Google_Service_Drive_User $user)
  {
    $this->user = $user;
  }
...
class Forminator_Google_Service_Drive_AboutStorageQuota extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $limit;
...
class Forminator_Google_Service_Drive_Change extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $fileType = 'Forminator_Google_Service_Drive_DriveFile';
  ...
  public function setFile(Forminator_Google_Service_Drive_DriveFile $file)
  {
    $this->file = $file;
  }
...
class Forminator_Google_Service_Drive_ChangeList extends Forminator_Google_Collection
{
  protected $collection_key = 'changes';
  protected $internal_gapi_mappings = array(
  );
  protected $changesType = 'Forminator_Google_Service_Drive_Change';
...
class Forminator_Google_Service_Drive_Channel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Forminator_Google_Service_Drive_Comment extends Forminator_Google_Collection
{
  protected $collection_key = 'replies';
  protected $internal_gapi_mappings = array(
  );
  public $anchor;
  protected $authorType = 'Forminator_Google_Service_Drive_User';
  ...
  public $kind;
  public $modifiedTime;
  protected $quotedFileContentType = 'Forminator_Google_Service_Drive_CommentQuotedFileContent';
  protected $quotedFileContentDataType = '';
  protected $repliesType = 'Forminator_Google_Service_Drive_Reply';
  ...
  public function setAuthor(Forminator_Google_Service_Drive_User $author)
  {
    $this->author = $author;
  }
  ...
  public function setQuotedFileContent(Forminator_Google_Service_Drive_CommentQuotedFileContent $quotedFileContent)
  {
...
class Forminator_Google_Service_Drive_CommentList extends Forminator_Google_Collection
{
  protected $collection_key = 'comments';
  protected $internal_gapi_mappings = array(
  );
  protected $commentsType = 'Forminator_Google_Service_Drive_Comment';
...
class Forminator_Google_Service_Drive_CommentQuotedFileContent extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $mimeType;
...
class Forminator_Google_Service_Drive_DriveFile extends Forminator_Google_Collection
{
  protected $collection_key = 'spaces';
  protected $internal_gapi_mappings = array(
  );
  public $appProperties;
  protected $capabilitiesType = 'Forminator_Google_Service_Drive_DriveFileCapabilities';
  protected $capabilitiesDataType = '';
  protected $contentHintsType = 'Forminator_Google_Service_Drive_DriveFileContentHints';
  ...
  public $iconLink;
  public $id;
  protected $imageMediaMetadataType = 'Forminator_Google_Service_Drive_DriveFileImageMediaMetadata';
  protected $imageMediaMetadataDataType = '';
  public $kind;
  protected $lastModifyingUserType = 'Forminator_Google_Service_Drive_User';
  ...
  public $ownedByMe;
  protected $ownersType = 'Forminator_Google_Service_Drive_User';
  protected $ownersDataType = 'array';
  public $parents;
  protected $permissionsType = 'Forminator_Google_Service_Drive_Permission';
  protected $permissionsDataType = 'array';
  public $properties;
  public $quotaBytesUsed;
  public $shared;
  public $sharedWithMeTime;
  protected $sharingUserType = 'Forminator_Google_Service_Drive_User';
  ...
  public $trashed;
  public $version;
  protected $videoMediaMetadataType = 'Forminator_Google_Service_Drive_DriveFileVideoMediaMetadata';
  ...
  public function setCapabilities(Forminator_Google_Service_Drive_DriveFileCapabilities $capabilities)
  {
  ...
  public function setContentHints(Forminator_Google_Service_Drive_DriveFileContentHints $contentHints)
  {
  ...
  public function setImageMediaMetadata(Forminator_Google_Service_Drive_DriveFileImageMediaMetadata $imageMediaMetadata)
  {
  ...
  public function setLastModifyingUser(Forminator_Google_Service_Drive_User $lastModifyingUser)
  {
  ...
  public function setSharingUser(Forminator_Google_Service_Drive_User $sharingUser)
  {
  ...
  public function setVideoMediaMetadata(Forminator_Google_Service_Drive_DriveFileVideoMediaMetadata $videoMediaMetadata)
  {
...
class Forminator_Google_Service_Drive_DriveFileCapabilities extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $canComment;
...
class Forminator_Google_Service_Drive_DriveFileContentHints extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexableText;
  protected $thumbnailType = 'Forminator_Google_Service_Drive_DriveFileContentHintsThumbnail';
  ...
  public function setThumbnail(Forminator_Google_Service_Drive_DriveFileContentHintsThumbnail $thumbnail)
  {
...
class Forminator_Google_Service_Drive_DriveFileContentHintsThumbnail extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $image;
...
class Forminator_Google_Service_Drive_DriveFileImageMediaMetadata extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $aperture;
  ...
  public $isoSpeed;
  public $lens;
  protected $locationType = 'Forminator_Google_Service_Drive_DriveFileImageMediaMetadataLocation';
  ...
  public function setLocation(Forminator_Google_Service_Drive_DriveFileImageMediaMetadataLocation $location)
  {
...
class Forminator_Google_Service_Drive_DriveFileImageMediaMetadataLocation extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $altitude;
...
class Forminator_Google_Service_Drive_DriveFileVideoMediaMetadata extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Drive_FileList extends Forminator_Google_Collection
{
  protected $collection_key = 'files';
  protected $internal_gapi_mappings = array(
  );
  protected $filesType = 'Forminator_Google_Service_Drive_DriveFile';
...
class Forminator_Google_Service_Drive_GeneratedIds extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Drive_Permission extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Drive_PermissionList extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Drive_Reply extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $action;
...
class Forminator_Google_Service_Drive_ReplyList extends Forminator_Google_Collection
{
  protected $collection_key = 'replies';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Drive_Revision extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_Drive_RevisionList extends Forminator_Google_Collection
{
  protected $collection_key = 'revisions';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $revisionsType = 'Forminator_Google_Service_Drive_Revision';
...
class Forminator_Google_Service_Drive_StartPageToken extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_Drive_User extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
