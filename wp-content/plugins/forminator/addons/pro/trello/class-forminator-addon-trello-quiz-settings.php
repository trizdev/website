...
class Forminator_Addon_Trello_Quiz_Settings extends Forminator_Addon_Quiz_Settings_Abstract {
	...
	public function setup_card( $submitted_data ) {
		...
		$template_params = array(
			'card_name'              => $this->get_multi_id_quiz_settings_value( $multi_id, 'card_name', esc_html__( 'New submission from {quiz_name}', 'forminator' ) ),
			'card_name_error'        => '',
		...
		$var_list              = array();
		$var_list['quiz_name'] = esc_html__( 'Quiz Name', 'forminator' );
