...
class Webauthn extends Controller {
	...
	public function get_translations(): array {
		$translations = [
			...
			'authenticator_verification_failed_user_handle_mismatch' => __( 'Due to some Biometric Authentication security improvements, the <strong>%s</strong> device will not work. Please delete this device and re-register it.', 'wpdef' ),
			'remove_auth' => __( 'Are you sure you want to remove authenticator?', 'wpdef' ),
			'login_failed' => __( 'ERROR: Verification failed.', 'wpdef' ),
			'login_user_handle_match_failed' => __( 'ERROR: Due to some Biometric Authentication security improvements, some of your registered devices might not work. Please ask your website administrator to reset 2FA for your account. Then navigate to your profile page to check which devices need re-registration.', 'wpdef' ),
			...
			'auth_user_handle_mismatch_notice' => __( 'This device might not work. Please delete the device and re-register it.', 'wpdef' ),
			'user_handle_mismatch_main_notice' => __( 'Due to some biometric authentication security improvements, some of your registered devices might not work. Please click the Authenticate Device button to check which devices you need to delete and re-registered.', 'wpdef' ),
		];
	...
	public function disable_user_handle_match_failed_notice(): void {
		...
		wp_send_json_success( __( 'Notice disabled!', 'wpdef' ) );
	}
