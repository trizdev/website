...
class Central extends Component {
			...
			wp_send_json_error(
				[
					...
					/* translators: %s: Name settings. */
						__( '%s is disabled. Please contact your hosting provider to enable it.', 'wpdef' ),
	...
	public function display_opcache_message() {
		...
		/* translators: 1. Option settings. 2. Name settings. */
			__( 'We have detected that your %1$s is disabled on your hosting. For Defender to function properly, please contact your hosting provider and ask them to enable %2$s.', 'wpdef' ),
