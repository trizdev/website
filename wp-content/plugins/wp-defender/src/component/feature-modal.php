	...
	*/
	...
	public function get_dashboard_modals(): array {
		...
		$desc = sprintf(
			...
			__( 'Hey %s! With Defender\'s Safe Repair feature, you no longer have to be cautious about breaking your site when deleting suspicious files! Suspicious and modified files can now be <strong>Quarantined</strong>, <strong>Deleted</strong>, or <strong>Replaced</strong> with the latest file copies from their official plugin repository.', 'wpdef' ),
		...
		return [
			...
			'welcome_modal' => [
				...
				'banner_alt' => __( 'Modal for Quarantine', 'wpdef' ),
				'button_title' => __( 'CHECK IT OUT!', 'wpdef' ),
				'button_title_free' => __( 'Get it now', 'wpdef' ),
