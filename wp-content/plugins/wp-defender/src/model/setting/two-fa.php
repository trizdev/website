...
class Two_Fa extends \Calotes\Model\Setting {
...
Your temporary password is {{passcode}}. To finish logging in, copy and paste the temporary password into the Password field on the login screen.',
	...
	public function labels(): array {
		return [
			...
			'custom_graphic' => __( 'Custom Graphic', 'wpdef' ),
			'custom_graphic_type' => __( 'Enable custom graphics above login fields', 'wpdef' ),
			'custom_graphic_url' => __( 'Upload Graphic', 'wpdef' ),
			'custom_graphic_link' => __( 'Link Graphic', 'wpdef' ),
