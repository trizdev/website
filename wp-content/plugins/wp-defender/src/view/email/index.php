...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            .report-list-item-path span { color:#0059FF; }
            ...
            /* 3.Text. */
            .report-list-item-path span:hover { color: #0C33A9 !important; }
                                                ...
                                                <td align="center" style="font-size:0;padding:0;word-break:break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0;">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <img height="30" width="27" src="<?php echo esc_url( $dashboard_whitelabel->get_branding_logo() ); ?>" style="border:0;outline:none;text-decoration:none;height:30px;width:27px;vertical-align:middle;" alt="<?php echo esc_attr( $title ); ?>">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:168px;">
                                                                    <img height="30" width="170" src="<?php echo esc_url( defender_asset_url( '/assets/email-images/wpmudev-logo@2x.png' ) ); ?>" style="border:0;display:block;outline:none;text-decoration:none;height:30px;width:170px;font-size:13px;" />
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                                        <tr class="hidden-img">
                                                            ...
                                                            <td style="vertical-align:middle;">
                                                                <span style="color:#333333;font-size:13px;font-weight:700;font-family:Roboto, Arial, sans-serif;line-height:25px;text-decoration:none;"> <?php esc_html_e( 'Follow us', 'wpdef' ); ?> </span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-size:0;height:25px;vertical-align:middle;text-align:center;width:25px;">
                                                                            <a href="https://www.facebook.com/wpmudev" target="_blank" style="display:inline-block;">
                                                                                <img height="14" width="7" src="<?php echo esc_url( defender_asset_url( '/assets/email-images/icon-fb.png' ) ); ?>" style="width:7px;height:14px;border-radius:3px;display:block;" />
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-size:0;height:25px;vertical-align:middle;text-align:center;width:25px;">
                                                                            <a href="https://www.instagram.com/wpmu_dev/" target="_blank" style="display:inline-block;">
                                                                                <img height="14" width="14" src="<?php echo esc_url( defender_asset_url( '/assets/email-images/icon-instagram.png' ) ); ?>" style="width:14px;height:14px;border-radius:3px;display:block;" />
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
