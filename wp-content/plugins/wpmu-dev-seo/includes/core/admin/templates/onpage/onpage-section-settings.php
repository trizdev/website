...
<div class="sui-box-settings-row wds-onpage-character-lengths">
	<div class="sui-box-settings-col-1">
		<label for="separator" class="sui-settings-label"><?php esc_html_e( 'Deactivate', 'wds' ); ?></label>
		<p class="sui-description">
			<?php esc_html_e( 'Use this option to deactivate the Title and Meta module from your site.', 'wds' ); ?>
		</p>
	</div>
	<div class="sui-box-settings-col-2">
		<button
			type="button"
			id="wds-deactivate-onpage-component"
