			...
			array(
				...
				'fields'     => array(
					array(
						...
						'strength'                     => 'none',
						'strength_validation_message'  => esc_html__( 'Your password doesn\'t meet the minimum strength requirement. We recommend using 8 or more characters with a mix of letters, numbers & symbols.', 'forminator' ),
						'validation'                   => 'true',
						'validation_message'           => esc_html__( 'Your passwords don\'t match.', 'forminator' ),
						'required_confirm_message'     => esc_html__( 'You must confirm your chosen password.', 'forminator' ),
					),
				),
			),
		);
